...
function SubmitForm() {
  ...
  return (
    <>
      <div className="pt-10 pl-10 pb-5 sm:pl-20 md:pl-40 lg:pl-60">
      ...
      <div className="p-10 pt-15 flex flex-col space-y-4 ml-10 mr-20 sm:ml-20 sm:mr-20 md:ml-40 md:mr-40 lg:ml-60 lg:mr-60">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <Link
              to="/page2" // Assuming "/page2" is the route where SubmissionList is rendered
